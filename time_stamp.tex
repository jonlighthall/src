%% Date settings-----------------%-------------------------------
%  This file provides definitions and commands to prints the time of compiling.

\usepackage{datetime} %provides commands for displaying times and dates
\usepackage{setspace}

%  Time zone definitions, for the command \timezone.
%  On Overleafm the timezone command requires a file named latexmkrc with the following contents
